...
ActiveRecord::Schema.define(version: 2022_03_22_140534) do
  ...
  create_table "training_menus", force: :cascade do |t|
    ...
    t.index ["training_record_id"], name: "index_training_menus_on_training_record_id"
  end
  ...
  add_foreign_key "training_menus", "training_records"
